// ActivityEditPagination/ActivityEditPagination.js
import React from 'react';
import { ChevronLeft, ChevronRight } from 'lucide-react';
import styles from './ActivityEditPagination.module.css';

function ActivityEditPagination({
  currentPage = 1,
  totalPages = 1,
  onPageChange,
  itemsPerPage = 10,
...
export default ActivityEditPagination;